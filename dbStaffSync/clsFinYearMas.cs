    ...
    public class clsFinYearMas
    {
        ...
        public List<FinYearMas> GetSpecificFinYearInfo(int txtFinYearID)
        {
            ...
            try
            {
                ...
                string strQuery = "SELECT FinYearID, FinYearFromTo, FinYearFrom, FinYearTo, IsDefault, OrderID FROM FinYearMas WHERE FinYearID = " + txtFinYearID + "";
        ...
        public List<FinYearMas> GetCompleteFinYearList()
        {
            ...
            try
            {
                ...
                string strQuery = "SELECT FinYearID, FinYearFromTo, FinYearFrom, FinYearTo, IsDefault, OrderID FROM FinYearMas Order By FinYearID Desc";
