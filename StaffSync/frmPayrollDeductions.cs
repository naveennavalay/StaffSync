    ...
    public partial class frmPayrollDeductions : Form
    {
        ...
        private void btnSaveDetails_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    strActionStatement = "PayrollDeductionsNewUpdates";
                ...
                {
                    strActionStatement = "PayrollDeductionsExistingUpdates";
                ...
                {
                    if (lblActionMode.Text == "add")
                        objAuditLog.InsertAuditLog(Convert.ToInt32(CurrentUser.EmpID.ToString()), Convert.ToInt32(lblDeductionID.Text.ToString()), changedValues.ToString().Trim(), "Insert", ModelStaffSync.CurrentUser.EmpName, strActionStatement, Convert.ToInt32(objTempClientFinYearInfo.ClientID));
                    else if (lblActionMode.Text == "modify")
                        objAuditLog.InsertAuditLog(Convert.ToInt32(CurrentUser.EmpID.ToString()), Convert.ToInt32(lblDeductionID.Text.ToString()), changedValues.ToString().Trim(), "Update", ModelStaffSync.CurrentUser.EmpName, strActionStatement, Convert.ToInt32(objTempClientFinYearInfo.ClientID));
                }
        ...
        {
            frmAuditLogStatements objAuditLogStatements = new frmAuditLogStatements(Convert.ToInt32(lblDeductionID.Text.ToString()), "PayrollDeductions", "Deduction Master Information", Convert.ToInt32(objTempClientFinYearInfo.ClientID));
