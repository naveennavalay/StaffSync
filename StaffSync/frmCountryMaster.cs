...
namespace StaffSync
{
    public partial class frmCountryMaster : Form
    {
        ...
        public frmCountryMaster(UserRolesAndResponsibilitiesInfo objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo, ClientFinYearInfo objSelectedClientFinYearInfo)
        {
            InitializeComponent();
            objTempCurrentlyLoggedInUserInfo = objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo;
        ...
        private void btnSaveDetails_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    strActionStatement = "CountryNewUpdates";
                ...
                {
                    strActionStatement = "CountryExistingUpdates";
        ...
        {
            frmAuditLogStatements objAuditLogStatements = new frmAuditLogStatements(Convert.ToInt32(lblCountryID.Text.ToString()), "Country", "Country Master", Convert.ToInt32(objTempClientFinYearInfo.ClientID));
