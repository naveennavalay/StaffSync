...
namespace StaffSync
{
    public partial class frmModuleAssignment : Form
    {
        ...
        public frmModuleAssignment(UserRolesAndResponsibilitiesInfo objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo, ClientFinYearInfo objSelectedClientFinYearInfo)
        {
            InitializeComponent();
            objTempCurrentlyLoggedInUserInfo = objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo;
        ...
        private void dtgModulesList_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            frmAuditLogStatements objAuditLogStatements = new frmAuditLogStatements(Convert.ToInt32(lblReportingManagerID.Text.ToString()), "ModuleAssignment", "Module Assignment", Convert.ToInt32(objTempClientFinYearInfo.ClientID));
