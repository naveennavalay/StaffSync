...
namespace StaffSync
{
    public partial class frmLeaveTypeMaster : Form
    {
        ...
        public frmLeaveTypeMaster(UserRolesAndResponsibilitiesInfo objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo)
        {
            InitializeComponent();
            objTempCurrentlyLoggedInUserInfo = objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo;
        }

        public frmLeaveTypeMaster(UserRolesAndResponsibilitiesInfo objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo, ClientFinYearInfo objSelectedClientFinYearInfo)
        {
            InitializeComponent();
            objTempCurrentlyLoggedInUserInfo = objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo;
        ...
        private void btnSaveDetails_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    strActionStatement = "LeaveTypeMasterInfoNewUpdates";
                ...
                {
                    strActionStatement = "LeaveTypeMasterInfoExistingUpdates";
                ...
                {
                    if (lblActionMode.Text == "add")
                        objAuditLog.InsertAuditLog(Convert.ToInt32(CurrentUser.EmpID.ToString()), Convert.ToInt32(lblLeaveTypeID.Text.ToString()), changedValues.ToString().Trim(), "Insert", ModelStaffSync.CurrentUser.EmpName, strActionStatement, Convert.ToInt32(objTempClientFinYearInfo.ClientID));
                    else if (lblActionMode.Text == "modify")
                        objAuditLog.InsertAuditLog(Convert.ToInt32(CurrentUser.EmpID.ToString()), Convert.ToInt32(lblLeaveTypeID.Text.ToString()), changedValues.ToString().Trim(), "Update", ModelStaffSync.CurrentUser.EmpName, strActionStatement, Convert.ToInt32(objTempClientFinYearInfo.ClientID));
                }
