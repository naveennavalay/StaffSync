...
namespace StaffSync
{
    public partial class frmLeaveStatements : Form
    {
        ...
        public frmLeaveStatements(UserRolesAndResponsibilitiesInfo objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo)
        {
            InitializeComponent();
            objTempCurrentlyLoggedInUserInfo = objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo;
        }

        public frmLeaveStatements(UserRolesAndResponsibilitiesInfo objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo, ClientFinYearInfo objSelectedClientFinYearInfo)
        {
            InitializeComponent();
            objTempCurrentlyLoggedInUserInfo = objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo;
        ...
        private void dtgLeaveStatement_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            frmAuditLogStatements objAuditLogStatements = new frmAuditLogStatements(Convert.ToInt32(lblEmpID.Text.ToString()), "LeaveStatementInformation", "Leave Statement Information", Convert.ToInt32(objTempClientFinYearInfo.ClientID));
