...
namespace StaffSync
{
    public partial class frmLeaveStatement : Form
    {
        ...
        public frmLeaveStatement()
        {
            InitializeComponent();
        }

        public frmLeaveStatement(UserRolesAndResponsibilitiesInfo objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo)
        {
            InitializeComponent();
            objTempCurrentlyLoggedInUserInfo = objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo;
        }

        public frmLeaveStatement(UserRolesAndResponsibilitiesInfo objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo, ClientFinYearInfo objSelectedClientFinYearInfo)
        {
            InitializeComponent();
            objTempCurrentlyLoggedInUserInfo = objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo;
        ...
        public void disableControls()
        {
            ...
            txtDateAsOn.Enabled = false;
        }

        private void btnSearch_Click(object sender, EventArgs e)
        {
            frmEmployeeList frmEmployeeList = new frmEmployeeList(this, "listLeaveStatement");
            frmEmployeeList.ShowDialog();
        }

        public void SelectedEmployeeID(string SearchOptionSelectedForm, int selectedEmployeeID)
        {
            if (SearchOptionSelectedForm == "listLeaveStatement")
            {
        ...
        private void frmLeaveStatement_Load(object sender, EventArgs e)
        {
            lblActionMode.Text = "";
            onCancelButtonClick();
            disableControls();
        ...
        private void frmLeaveStatement_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            frmAuditLogStatements objAuditLogStatements = new frmAuditLogStatements(Convert.ToInt32(lblLeaveMasID.Text.ToString()), "LeaveStatementInformation", "Leave Statement Information", Convert.ToInt32(objTempClientFinYearInfo.ClientID));
