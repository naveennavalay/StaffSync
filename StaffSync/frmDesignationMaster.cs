...
namespace StaffSync
{
    public partial class frmDesignationMaster : Form
    {
        ...
        {
            frmAuditLogStatements objAuditLogStatements = new frmAuditLogStatements(Convert.ToInt32(lblCountryID.Text.ToString()), "Designation", "Designation Master", Convert.ToInt32(objTempClientFinYearInfo.ClientID));
