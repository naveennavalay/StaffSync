...
namespace StaffSync
{
    public partial class frmDesignationMaster : Form
    {
        ...
        public frmDesignationMaster(UserRolesAndResponsibilitiesInfo objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo)
        {
            InitializeComponent();
            objTempCurrentlyLoggedInUserInfo = objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo;
        }

        public frmDesignationMaster(UserRolesAndResponsibilitiesInfo objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo, ClientFinYearInfo objSelectedClientFinYearInfo)
        {
            InitializeComponent();
            objTempCurrentlyLoggedInUserInfo = objCurrentlyLoggedInUserRolesAndResponsibilitiesInfo;
        ...
        {
            frmDesignationList frmDesignationList = new frmDesignationList(this);
            frmDesignationList.ShowDialog(this);
        }
        ...
        private void btnSaveDetails_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtDesigTitle.Text))
            {
                txtDesigTitle.Focus();
                errValidator.SetError(this.txtDesigTitle, "Please enter Country Title");
            }
            else if (string.IsNullOrEmpty(txtDesigInitial.Text))
            {
                txtDesigInitial.Focus();
                errValidator.SetError(this.txtDesigInitial, "Please enter Country Initial");
            }
            ...
            else
            {
                ...
                {
                    strActionStatement = "DesignationNewUpdates";
                    onlyChangedValues = AuditLogger.getUpdatedValues(_originalValues, updatedValues, true);

                    int newID = objDesignation.InsertDesignation(txtDesigCode.Text.Trim(), txtDesigTitle.Text.Trim(), txtDesigInitial.Text.Trim(), cmbIsActive.Text.Trim() == "Yes" ? true : false, false);
                    if (newID > 0)
                        MessageBox.Show("Details inserted successfully", "Staffsync", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else if (lblActionMode.Text == "modify")
                {
                    strActionStatement = "DesignationExistingUpdates";
                    onlyChangedValues = AuditLogger.getUpdatedValues(_originalValues, updatedValues, false);

                    int affectedRows = objDesignation.UpdateDesignation(Convert.ToInt16(lblCountryID.Text.Trim()), txtDesigCode.Text.Trim(), txtDesigTitle.Text.Trim(), txtDesigInitial.Text.Trim(), cmbIsActive.Text.Trim() == "Yes" ? true : false, false);
                    if (affectedRows > 0)
        ...
        public void enableControls()
        {
            ...
            txtDesigCode.ReadOnly = true;
            txtDesigTitle.Enabled = true;
            txtDesigInitial.Enabled = true;
            cmbIsActive.Items.Clear();
            cmbIsActive.Items.Add("");
            cmbIsActive.Items.Add("Yes");
            cmbIsActive.Items.Add("No");
        ...
        public void disableControls()
        {
            ...
            txtDesigCode.ReadOnly = true;
            txtDesigTitle.Enabled = false;
            txtDesigInitial.Enabled = false;
            cmbIsActive.Items.Clear();
            cmbIsActive.Items.Add("");
            cmbIsActive.Items.Add("Yes");
            cmbIsActive.Items.Add("No");
        ...
        public void displaySelectedValuesOnUI(DesignationModel designationModel)
        {
            lblCountryID.Text = designationModel.DesignationID.ToString();
            txtDesigCode.Text = designationModel.DesignationCode;
            txtDesigTitle.Text = designationModel.DesignationTitle;
            txtDesigInitial.Text = designationModel.DesignationInitial;
            cmbIsActive.Text = designationModel.IsActive == true ? "Yes" : "No";
        ...
        private void btnRemoveDetails_Click(object sender, EventArgs e)
        {
            ...
            else if (lblActionMode.Text == "delete")
            {
                ...
                {
                    int affectedRows = objDesignation.DeleteDesignation(Convert.ToInt16(lblCountryID.Text.Trim()));
                    if (affectedRows > 0)
        ...
        {
            frmAuditLogStatements objAuditLogStatements = new frmAuditLogStatements(Convert.ToInt32(lblCountryID.Text.ToString()), "DesignationMaster", "Designation Master", Convert.ToInt32(objTempClientFinYearInfo.ClientID));
