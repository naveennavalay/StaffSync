...
namespace DALStaffSync
{
    public class clsEmpPayroll
    {
        ...
        public int InsertEmployeeSalaryMasterInfo(int txtEmpID, DateTime txtSalaryDate, string txtSalaryMonthYear, decimal txtTotalWorkingDays, decimal txtTotalWorkedDays, decimal txtTotalLeavesTaken, decimal txtNetPayableAmount, int txtOrderID)
        {
            ...
            affectedRows = objEmpPayroll.InsertEmployeeSalaryMasterInfo(txtEmpID, txtSalaryDate, txtSalaryMonthYear, txtTotalWorkingDays, txtTotalWorkedDays, txtTotalLeavesTaken, txtNetPayableAmount, txtOrderID);
        ...
        public int UpdateEmployeeSalaryMasterInfo(int txtEmpSalID, int txtEmpID, DateTime txtSalaryDate, string txtSalaryMonthYear, double txtTotalWorkingDays, double txtTotalWorkedDays, double txtTotalLeavesTaken, double txtNetPayableAmount)
        {
            ...
            affectedRows = objEmpPayroll.UpdateEmployeeSalaryMasterInfo(txtEmpSalID, txtEmpID, txtSalaryDate, txtSalaryMonthYear, txtTotalWorkingDays, txtTotalWorkedDays, txtTotalLeavesTaken, txtNetPayableAmount);
        ...
        public int InsertEmployeeSalaryDetailsInfo(int txtEmpSalID, int txtSalProDetID, int txtSalHeaderID, string txtSalHeaderTitle, string txtSalSalHeaderType, decimal txtAllAmount, decimal txtDedAmount, decimal txtReimbAmount, int txtOrderID)
        {
            ...
            affectedRows = objEmpPayroll.InsertEmployeeSalaryDetailsInfo( txtEmpSalID, txtSalProDetID, txtSalHeaderID, txtSalHeaderTitle, txtSalSalHeaderType, txtAllAmount, txtDedAmount, txtReimbAmount, txtOrderID);
        ...
        public int UpdateEmployeeSalaryDetailsInfo(int txtEmpSalDetID, int txtEmpSalID, int txtSalProDetID, int txtSalHeaderID, string txtSalHeaderTitle, string txtSalSalHeaderType, decimal txtAllAmount, decimal txtDedAmount, decimal txtReimbAmount, int txtOrderID)
        {
            ...
            affectedRows = objEmpPayroll.UpdateEmployeeSalaryDetailsInfo(txtEmpSalDetID, txtEmpSalID, txtSalProDetID, txtSalHeaderID, txtSalHeaderTitle, txtSalSalHeaderType, txtAllAmount, txtDedAmount, txtReimbAmount, txtOrderID);
